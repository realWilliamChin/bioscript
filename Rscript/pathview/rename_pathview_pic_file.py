...
def parse_input():
    ...
    parser.add_argument('-p', '--passed-path-file', dest='input_file', default='passed_path.txt',
...
def rename(input_dir, ref_file):
    ...
    for png in ko_png_list:
        ...
        replace_name = ref_df[ref_df['KO'] == png_ko_name]['Def'].to_list()[0]
        # print(type(replace_name), replace_name)
        # exit(0)
        replace_name = f'{png_ko_name}_{replace_name}.ko.data.png'
