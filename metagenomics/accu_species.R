...
plot(sp, ci.type = 'poly', col = 'blue', lwd = 2, ci.lty = 0, ci.col = 'white', bty="L",xlim = c(0, max(nrow(otu))),ylim=c(sp.min,sp.max),xaxt = "n",yaxt="n",xlab="Sample Number",ylab="Species Count")
